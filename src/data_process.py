...
def load_data(dataset_str: str) -> tuple:
    ...
    if dataset_str in ["cora", "cadets", "cadets_all", "theia", "trace", "trace"]:
        ...
        # 创建 torch_sparse 的 SparseTensor
